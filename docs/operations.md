...
`onyx-sim-capacity-lab` is centered on simulations work in C#. The technical target is: Create a C# reference implementation for capacity workflows, centered on visual model generation, layout fixtures, and stable geometry snapshots.
...
The score is deterministic. The current threshold is 178. Risk has a penalty of 5, latency has a penalty of 2, and weight contributes a bonus of 2.
